...
//   // Watch local cache
//   // -------------------------
//   Stream<List<EventModel>> watchProducts() {
...
//     //
//     //   final products = (data as List).cast<Map<String, dynamic>>().map(EventModel.fromDb).toList();
//     //
//     //   _ob.store.runInTransaction(obx.TxMode.write, () {
//     //     // رکوردهای dirty را نگه دار
//     //     final dirty = _ob.productBox.query(EventModel.isDirty.equals(true)).build().find();
//     //     _ob.productBox.removeAll();
//     //
//     //     for (final p in products) {
//     //       _ob.productBox.put(ProductModel.fromProduct(p, isDirty: false));
//     //     }
...
//   Future<EventModel> upsert(EventModel draft) async {
...
//   }
//
//   Future<EventModel> _insertRemote(EventModel draft, String userId) async {
...
//         .single();
//
//     final product = EventModel.fromDb(updatedRow);
//
...
//   }
//
//   Future<EventModel> _updateRemote(EventModel product, String userId) async {
//     final urls = await _uploadImagesIfNeeded(
...
//         .single();
//
//     final updated = EventModel.fromDb(row);
//
...
//     // if (user == null) return;
//     //
//     // final q = _ob.productBox.query(EventModel.isDirty.equals(true)).build();
//     // final dirty = q.find();
//     // q.close();
//     //
...
//   }
//
//   Future<void> _cacheImagesForProduct(EventModel p) async {
...
//   // }
//
//   void _upsertLocalCache(EventModel product, {required bool isDirty}) {
//     // final q = _ob.productBox.query(EventModel_.id.equals(product.id)).build();
//     // final existing = q.findFirst();
//     // q.close();
//     //
//     // if (existing != null) {
//     //   // product.obId = existing.obId;
//     // }
//     // _ob.productBox.put(product);
//   }
//
